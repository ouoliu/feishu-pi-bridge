 ...
 */
export function createBot(cfg, onMessage) {
    ...
    channel.on({
        message: async (msg) => {
            console.error(`[消息] chat=${msg.chatId.slice(-8)} type=${msg.chatType} ` +
...
function buildLogger() {
    return {
        error: (...args) => {
            ...
            if (msg.includes('131005') || msg.includes('1069307') || msg.includes('1069302'))
                return;
